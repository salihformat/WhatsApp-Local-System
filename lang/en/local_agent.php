...
return [
    ...
    'action_print_only' => 'Save + Print (no send) — default',
    ...
    'action_saved_location_hint' => 'The file is saved to a "saved" folder inside the monitor folder (separate from "archive", which holds files that were actually sent).',
    'edit' => 'Edit',
    'delete' => 'Delete',
