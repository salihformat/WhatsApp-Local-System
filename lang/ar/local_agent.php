...
return [
    ...
    // لوحة التحكم
    'dashboard_title' => 'لوحة تحكم واتساب المحلي',
    'services_running' => 'الخدمات تعمل',
    'services_stopped' => 'الخدمات متوقفة',
    'dashboard_subtitle' => 'إدارة متكاملة لعمليات الإرسال، مراقبة المجلد النشط، معالجة الطوابير وإعادة إرسال الرسائل المتعثرة بضغطة زر.',
    'start_services_hidden' => 'تشغيل الخدمات (مخفية)',
    'stop_services' => 'إيقاف الخدمات',
    'scan_folder_now' => 'فحص المجلد الآن',
    'retry_failed' => 'إعادة إرسال الفاشلة',
    'start_queue' => 'تشغيل الطابور',
    'restart_queue' => 'إعادة تشغيل الطابور',
    'check_server_connection' => 'فحص الاتصال بالسيرفر',
    'pending_approval_title' => 'هناك طلبات بانتظار موافقتك',
    'print_requests_count' => ':count طلب طباعة',
    'send_review_count' => ':count ملف بانتظار مراجعة الإرسال',
    'review_print_requests' => 'مراجعة طلبات الطباعة',
    'review_send_requests' => 'مراجعة طلبات الإرسال',
    ...
    'folder_status_title' => 'حالة مجلد المراقبة',
    'folder_connected' => 'متصل ونشط',
    'folder_disconnected' => 'غير متصل',
    'active_path' => 'المسار النشط:',
    'server_connected' => 'متصل بالسيرفر',
    'server_disconnected' => 'غير متصل بالسيرفر',
    'folder_pending_scan' => 'بانتظار الفحص',
    'folder_archived' => 'مؤرشفة',
    'folder_failed_files' => 'ملفات خاطئة',
    'folder_not_writable' => 'المجلد غير قابل للكتابة، قد يفشل أرشفة الملفات.',
    'delivery_trend_title' => 'معدل تسليم الرسائل (آخر 7 أيام)',

    'recent_activity_title' => 'الأنشطة وسجلات الإرسال الأخيرة',
    'view_all_messages' => 'عرض جميع الرسائل',
    'col_message_id' => 'رقم الرسالة',
    'col_recipient' => 'المستلم',
    'col_message_content' => 'محتوى الرسالة',
    'col_message_type' => 'نوع الرسالة',
    'col_attached_file' => 'الملف المرفق',
    'col_status' => 'الحالة',
    'col_created_at' => 'تاريخ الإنشاء',
    'col_actions' => 'الإجراءات',
    'type_media' => 'وسائط وملف',
    'type_text' => 'رسالة نصية',
    'no_active_messages' => 'لا توجد رسائل نشطة حالياً. قم بإدخال ملفات في مجلد المراقبة للبدء تلقائياً!',
    'retry_send' => 'إعادة محاولة الإرسال',
    'view_details' => 'عرض التفاصيل',

    // حالات الرسائل
    'status_read' => 'تم القراءة',
    ...
    // مهام الطباعة
    'print_jobs_title' => 'مهام الطباعة',
    'print_status_pending' => 'قيد الانتظار',
    'print_status_awaiting_approval' => 'بانتظار الموافقة',
    'print_status_printing' => 'جارٍ الطباعة',
    'print_status_completed' => 'مكتملة',
    'print_status_failed' => 'فشلت',
    'print_status_rejected' => 'مرفوضة',
    'col_file' => 'اسم الملف',
    'col_printer' => 'الطابعة',
    'col_source' => 'المصدر',
    'col_attempts' => 'المحاولات',
    'col_pages' => 'الصفحات',
    'col_arrived_at' => 'وقت الوصول',
    ...
    'search_by_phone' => 'ابحث برقم الجوال...',
    'search_by_filename' => 'ابحث باسم الملف...',
    'all_printers' => 'الكل',
    'export' => 'تصدير Excel',
    'export_csv_hint' => 'تصدير النتائج الحالية إلى ملف Excel (CSV)',
    'reset' => 'إعادة ضبط',

    // الطابعات
    'printers_title' => 'إدارة الطابعات',
    'add_printer_title' => 'إضافة طابعة جديدة',
    'printer_display_name' => 'اسم مختصر (للعرض)',
    'printer_windows_name' => 'اسم الطابعة في Windows',
    'printer_type' => 'النوع',
    'printer_mode' => 'وضع الطباعة',
    'printer_mode_auto' => 'تلقائي (يُطبع فوراً)',
    'printer_mode_approval' => 'يتطلب موافقة',
    'printer_default' => 'طابعة افتراضية',
    'printer_active' => 'نشطة',
    'printer_inactive' => 'مفعّلة',
    'printer_add_button' => 'إضافة',
    'col_windows_name' => 'اسم WINDOWS',
    'col_type' => 'النوع',
    'col_mode' => 'وضع الطباعة',
    'col_default' => 'افتراضية',
    'col_customer_ack' => 'تأكيد الطباعة للعميل',
    'col_backup' => 'احتياطية',
    'col_health_status' => 'حالة الطابعة',
    'printer_healthy' => 'سليمة',
    'printer_unhealthy' => 'غير متصلة',
    'printer_unverified' => 'غير مؤكَّدة',
    'checked_minutes_ago' => 'منذ :count دقيقتين',
    'check_now' => 'فحص الآن',
    'manage_routing_rules' => 'إدارة قواعد التوجيه',
    'view_print_log' => 'سجل عمليات الطباعة',
    'printer_display_placeholder' => 'طابعة الاستقبال',
    'printer_type_document' => 'مستندات (PDF)',
    'printer_type_thermal' => 'حرارية / ملصقات (قريباً)',
    'printer_type_document_short' => 'مستندات',
    'printer_type_thermal_short' => 'حرارية',
    'printer_default_hint' => 'تُستخدم هذه الطابعة تلقائياً لطباعة أي ملف قابل للطباعة لا يُطابق أي قاعدة توجيه محددة — طابعة واحدة فقط يمكن أن تكون افتراضية.',
    'col_backup_hint' => 'عند تعطّل هذه الطابعة (حسب آخر فحص دوري)، تُحوَّل مهام الطباعة الجديدة تلقائياً لهذه الطابعة الاحتياطية.',
    'col_job_count' => 'عدد مهام الطباعة',
    'col_pages_printed' => 'الصفحات المطبوعة',
    'col_pages_printed_hint' => 'إجمالي الصفحات المطبوعة فعلياً — تقدير تقريبي لتخطيط استهلاك الحبر/الورق.',
    'printer_mode_hint' => 'تلقائي: يُطبع فوراً. يتطلب موافقة: يُحجز الطلب حتى تُوافق عليه عبر لوحة التحكم أو رد واتساب.',
    'printer_mode_auto_short' => 'تلقائي',
    'printer_disabled' => 'معطّلة',
    'supports_status_check_hint' => 'فعّلها فقط بعد تأكيد يدوي أن الطابعة تُبلّغ فعلياً عن نفاد الورق/الحبر عبر Windows.',
    'status_check_verified' => 'موثوقة ✓',
    'not_checked_yet' => 'لم تُفحص بعد',
    'printer_status_healthy' => 'تعمل بشكل طبيعي',
    'printer_status_error' => 'بها مشكلة',
    'printer_status_unknown' => 'غير معروفة',
    'no_auto_failover' => 'بلا تحويل تلقائي',
    'toggle_active' => 'تفعيل/تعطيل',
    'confirm_delete_printer' => 'هل أنت متأكد من حذف هذه الطابعة؟ سيتم مسح أي مهام طباعة معلقة لها.',
    'delete_printer' => 'حذف الطابعة',
    'no_printers_yet' => 'لا توجد طابعات مضافة بعد',
    'printing_disabled_notice' => 'ميزة الطباعة الذكية معطّلة حالياً (PRINTING_ENABLED=false في .env). يمكنك إعداد الطابعات والقواعد الآن، لكن لن تُطبع أي ملفات فعلياً حتى تفعيلها.',

    // صحة النظام
    'system_health_title' => 'لوحة صحة النظام',
    'central_connection' => 'الاتصال بالنظام المركزي',
    'connection_disconnected' => 'منقطع',
    'connection_connected' => 'متصل',
    'failed_last_hour' => 'فشل خلال آخر ساعة',
    'out_of_total_failed' => 'من أصل :count فاشلة إجمالاً',
    'stuck_messages' => 'رسائل معلّقة (+10 دقائق)',
    'out_of_total_pending' => 'من أصل :count معلّقة',
    'queue_backlog' => 'تراكم الطابور',
    'jobs_not_processed_yet' => 'مهام لم تُعالَج بعد',
    'manage_failed_jobs' => 'إدارة المهام الفاشلة تقنياً',
    'scan_all' => 'مسح الكل',
    'restart' => 'إعادة التشغيل',
    'last_scan' => 'آخر فحص',
    'minutes_ago' => 'منذ :count دقيقتين',
    'recent_errors_title' => 'آخر الأخطاء الفنية (من سجلات هذا النظام)',
    'print_health_title' => 'صحة الطباعة والمراجعة اليدوية',
    'send_awaiting_review' => 'إرسال بانتظار مراجعة يدوية',
    'review_now' => 'مراجعة الآن',
    'print_failed_today' => 'طباعة فاشلة اليوم',
    'print_awaiting_approval' => 'طباعة بانتظار موافقة',
    'printers_with_issues' => 'طابعات بها مشكلة',
    'manage_printers' => 'إدارة الطابعات',
    'trend_last_checks' => 'اتجاه آخر 7 فحصاً',
    'col_time' => 'الوقت',
    'col_central' => 'المركزي',
    'no_health_data_yet' => 'لا توجد بيانات فحص بعد — سيبدأ الفحص تلقائياً كل 10 دقائق.',
    'job_count' => ':count مهمة',
    'restart_queue_hint' => 'إعادة تشغيل عامل الطابور لمعالجة المهام',
    'confirm_clear_queue' => 'تحذير: سيتم مسح كل المهام المعلقة في الطابور نهائياً. هل أنت متأكد؟',
    'clear_all_hint' => 'مسح كافة المهام المتراكمة نهائياً',
    'no_recent_errors' => 'لا توجد أخطاء حديثة مسجّلة.',
    'now_active' => 'مُفعَّلة الآن',
    'no_active_printers' => 'لا توجد طابعات مفعّلة.',
    'no_history_yet' => 'لا يوجد سجل بعد',

    // سجل التدقيق
    'audit_log_title' => 'سجل التدقيق (Audit Log)',
    'filter' => 'تصفية',
    'all_types' => 'الكل',
    'all_users' => 'الكل',
    'search_in_description' => 'بحث في الوصف...',
    'from_date' => 'من تاريخ',
    'to_date' => 'إلى تاريخ',
    'col_when' => 'الوقت',
    'col_user' => 'المستخدم',
    'col_activity_type' => 'النوع',
    'col_event' => 'الحدث',
    'col_description' => 'الوصف',
    'col_details' => 'التفاصيل',
    'view_details_link' => 'عرض',
    'system_actor' => 'النظام',
    'event_created' => 'إنشاء',
    'event_updated' => 'تعديل',
    'event_deleted' => 'حذف',
    ...
    'log_name_default' => 'عام',
    'log_name_print_monitor' => 'مراقب الطباعة',
    'log_name_auth' => 'المصادقة',
    'log_name_system' => 'النظام',
    'log_name_users' => 'المستخدمين',
    'log_name_messages' => 'الرسائل',
    'log_name_contacts' => 'جهات الاتصال',
    'log_name_print_rules' => 'قواعد الطباعة',
    'log_name_printers' => 'الطابعات',
    'log_name_services' => 'الخدمات',
    'log_name_settings' => 'الإعدادات',
    'no_audit_logs_yet' => 'لا توجد سجلات تدقيق بعد',

    // متابعة مجلد المراقبة
    'print_monitor_title' => 'متابعة مجلد المراقبة (PrintMonitor)',
    'approve_all_pending' => 'موافقة على كل الملفات المعلّقة',
    'auto_send_disabled_notice' => 'الإرسال التلقائي مفعّل لهذا المجلد — تُرسل الملفات فور استخراج رقم جوال بثقة كافية. لتفعيل موافقة إلزامية على كل ملف قبل إرساله، اضبط MONITOR_FOLDER_REQUIRE_APPROVAL=true في .env.',
    'folder_pending' => 'قيد الانتظار (لم تُعالَج بعد)',
    'folder_review' => 'بانتظار المراجعة',
    'folder_processing' => 'قيد المعالجة الآن',
    'folder_sent' => 'أُرسلت بنجاح',
    'folder_failed' => 'فشلت',
    'col_file_name' => 'اسم الملف',
    'col_size' => 'الحجم',
    'col_modified' => 'آخر تعديل',
    'col_phone' => 'رقم الجوال',
    'col_search_details' => 'تفاصيل البحث',
    'col_failure_reason' => 'سبب الفشل',
    'col_action' => 'الإجراء',
    'no_files' => 'لا توجد ملفات',
    'view_details_short' => 'عرض التفاصيل',
    'review_reason_notice' => 'هذه الملفات إما استُخرج رقم الجوال لها من مصدر منخفض الثقة (بلا تسمية صريحة)، أو تتطلب موافقة عامة، أو تعذّر استخراج أي رقم لها تلقائياً — أدخل الرقم يدوياً في الحقل أعلاه ثم اضغط "إرسال". راجع "تفاصيل البحث" لمعرفة السبب قبل الموافقة أو الرفض.',
    'pending_send' => 'قيد الإرسال...',

    'confirm_approve_all_pending' => 'هل أنت متأكد من الموافقة على كل الملفات المعلّقة حالياً؟',
    'no_pending_review_files' => 'لا توجد ملفات بانتظار المراجعة حالياً',
    'folder_missing_notice' => 'المجلد :path غير موجود حالياً — سيُنشأ تلقائياً عند أول تشغيل لأمر monitor:folder.',
    'approval_required_notice' => '⏸️ "موافقة قبل الإرسال" مفعّلة لكل ملفات هذا المجلد — لن يُرسل أي ملف عبر واتساب تلقائياً، بل يصل طلب موافقة لرقم المسؤول ويظهر هنا بقسم "بانتظار المراجعة" أدناه. وافِق عبر الزر أدناه أو برد واتساب "وافق ارسال <رقم الرسالة>" / "رفض ارسال <رقم الرسالة>" (أو "ارسل لي الملف ارسال <رقم الرسالة>" لمعاينته أولاً).',
    'last_100_only' => 'آخر 100 فقط',
    'no_phone_found' => 'لم يتم العثور على رقم جوال في اسم الملف أو محتواه',
    'stale_file_notice' => 'نسخة قديمة من الملف — آخر محاولة إرسال بنفس الاسم نجحت لاحقاً (الحالة الحالية: :status). يمكن حذف هذا الملف بأمان.',
    'hide' => 'إخفاء',
    'message_record_not_found' => 'لم يُعثر على سجل الرسالة',
    'confirm_send_to_number' => 'سيتم إرسال الملف فعلياً إلى هذا الرقم. متابعة؟',
    'manual_phone_entry_hint' => 'لم يتمكن النظام من استخراج رقم جوال تلقائياً — أدخله هنا',
    'send' => 'إرسال',
    'confirm_reject_file' => 'سيتم رفض هذا الملف ونقله لمجلد فشلت بدون إرسال. متابعة؟',
    'confirm_send_to' => 'سيتم إرسال الملف فعلياً إلى :phone. متابعة؟',
    'approve_and_send' => 'موافقة وإرسال',
    'extraction_method' => 'آلية الاستخراج',
    'learned_trust_notice' => 'تم تخطي المراجعة اليدوية تلقائياً — رقم موثوق بالتعلّم من موافقات سابقة على نفس الرقم من نفس المصدر.',
    'rtl_corrected_notice' => 'تم تصحيح انعكاس ترتيب الأحرف العربية في النص قبل المطابقة (مشكلة معروفة في استخراج بعض ملفات PDF).',
    'pdf_ocr_notice' => 'طبقة نص الملف كانت تالفة/غير موجودة — تم تحويل الصفحة الأولى لصورة وقراءتها عبر OCR للحصول على النتيجة.',
    'matched_label' => 'الكلمة المطابقة',
    'extracted_file_number' => 'رقم الملف المستخرج',
    'matching_contact_found' => 'تم العثور على جهة اتصال مطابقة',
    'no_matching_contact' => 'لا توجد جهة اتصال بهذا الرقم',
    'excluded_candidates' => 'أرقام تم تجاهلها أثناء البحث',
    'matched_word' => 'طابق كلمة',
    'but_excluded_because' => 'لكن استُبعد بسبب وجود كلمة',
    'nearby' => 'قريباً منه',
    'confirm_default' => 'موافق',
    'are_you_sure' => 'هل أنت متأكد؟',
    'cancel' => 'إلغاء',

    // أسباب استخراج رقم الجوال (PrintMonitorController::traceSourceLabel)
    'trace_filename' => 'رقم الجوال مُستخرج من اسم الملف',
    'trace_label' => 'رقم الجوال مُستخرج من محتوى الملف (كلمة دلالة)',
    'trace_file_number' => 'تم العثور على رقم ملف داخل المستند وتم البحث عنه في جهات الاتصال',
    'trace_file_number_verified' => 'لم توجد تسمية دقيقة، فتم البحث عن أي رقم قرب كلمة "no"/"رقم" والتحقق منه مقابل جهات الاتصال مباشرة',
    'trace_ocr_missing' => 'تعذّرت القراءة البصرية (OCR) — البرنامج غير مثبَّت',
    'trace_ocr_error' => 'تعذّرت القراءة البصرية (OCR) لهذا الملف',
    'trace_empty_image_text' => 'الصورة/الصفحة الممسوحة ضوئياً لا تحتوي نصاً يمكن قراءته',
    'trace_unlabeled_fallback' => 'لم توجد كلمة دلالة، تم استخدام أول رقم يشبه جوالاً سعودياً في المحتوى',
    'trace_corrupted_fallback' => 'طبقة النص تبدو تالفة (مشكلة ترميز عربي)، تم البحث عن رقم بلا تسمية فقط',
    'trace_env_fallback' => 'تم استخدام رقم الجوال الاحتياطي من الإعدادات (MONITOR_FALLBACK_PHONE)',
    'trace_parse_error' => 'تعذّرت قراءة محتوى الملف',
    'trace_empty_text' => 'الملف لا يحتوي على طبقة نص قابلة للقراءة',
    'trace_no_match_in_content' => 'لم يُعثر على أي رقم أو تسمية صالحة داخل المحتوى',
    'trace_none' => 'لم تتم أي محاولة استخراج (لا اسم ملف ولا محتوى مطابق)',
    'trace_unknown' => 'غير معروف',

    // حالة اتصال السيرفر (DashboardController)
    'checking_connection' => 'جاري الفحص...',
    'server_connected_ok' => 'متصل بالسيرفر بنجاح (المصادقة سليمة)',
    'server_connected_with_error' => 'متصل لكن يوجد خطأ: :detail',
    'check_token_and_company' => 'تحقق من التوكن ورقم الشركة',
    'server_unreachable' => 'لا يمكن الوصول للسيرفر (تأكد من العنوان أو أن السيرفر يعمل)',
    'connection_error' => 'خطأ في الاتصال: :detail',
    'server_url_not_set' => 'لم يتم تعيين رابط السيرفر (CENTRAL_API_URL)',
    'whatsapp_not_checked' => 'لم يتم الفحص (السيرفر المركزي غير متصل)',
    'whatsapp_connected' => 'واتساب متصل',
    'whatsapp_disconnected' => 'واتساب غير متصل',
    'whatsapp_check_failed' => 'تعذّر التحقق من حالة واتساب',
    'check_whatsapp_connection' => 'فحص اتصال واتساب',
    'central_blocking_error_title' => 'يوجد خطأ يمنع إرسال جميع الرسائل من النظام المركزي',
    'read_more' => 'قراءة المزيد',

    // قواعد توجيه الطباعة
    'print_rules_title' => 'قواعد توجيه الطباعة',
    'print_rules_need_printer' => 'يجب :link واحدة على الأقل قبل إنشاء قواعد التوجيه.',
    'add_a_printer' => 'إضافة طابعة',
    'add_routing_rule' => 'إضافة قاعدة توجيه',
    'rule_name' => 'اسم القاعدة',
    'rule_name_placeholder' => 'مثال: فواتير المحاسبة',
    'match_type' => 'نوع المطابقة',
    'match_phone_number' => 'رقم جوال محدد',
    'match_phone_prefix' => 'بادئة رقم الجوال',
    'match_keyword' => 'كلمة مفتاحية',
    'match_file_type' => 'امتداد الملف',
    'match_value' => 'القيمة',
    'match_value_hint' => 'يمكن وضع أكثر من قيمة مفصولة بفاصلة، لأي نوع مطابقة',
    'match_value_hint_short' => 'يمكن وضع أكثر من قيمة مفصولة بفاصلة',
    'match_value_placeholder' => 'مثال: طباعة,اطبع,print — أو أرقام: 966501111111,966502222222',
    'priority' => 'الأولوية',
    'priority_hint' => 'الأصغر يُفحص أولاً',
    'add_rule' => 'إضافة القاعدة',
    'condition' => 'الشرط',
    'condition_phone_eq' => 'رقم =',
    'condition_prefix_eq' => 'بادئة =',
    'condition_contains_word' => 'كلمة تحتوي',
    'condition_ext_eq' => 'امتداد =',
    'action_type' => 'الإجراء',
    'action_print_and_send' => 'طباعة + إرسال عبر واتساب',
    'action_print_only' => 'حفظ + طباعة (بلا إرسال) — الافتراضي',
    'action_send_only' => 'إرسال فقط بلا طباعة',
    'action_save_only' => 'حفظ فقط (بلا طباعة ولا إرسال)',
    'action_hold_for_approval' => 'تعليق حتى موافقة يدوية',
    'action_saved_location_hint' => 'يُحفظ الملف في مجلد "saved" داخل مجلد المراقبة (منفصل عن "archive" الخاص بالملفات المُرسَلة فعلياً).',
    'edit' => 'تعديل',
    'delete' => 'حذف',
    'confirm_delete_rule' => 'هل أنت متأكد من حذف هذه القاعدة؟',

    // Conversations index
    'conv_search_placeholder' => 'بحث برقم الهاتف أو الاسم...',
    'conv_filter' => 'تصفية',
    'conv_reset' => 'إعادة تعيين',
    'conv_media' => 'وسائط',
    'conv_no_messages' => 'لا يوجد رسائل',
    'conv_open_tooltip' => 'فتح المحادثة',
    'conv_close_tooltip' => 'إغلاق المحادثة',
    'conv_confirm_close' => 'هل أنت متأكد من إغلاق هذه المحادثة؟',

    // Conversation show
    'conv_end' => 'إنهاء المحادثة',
    'conv_reopen' => 'إعادة فتح المحادثة',
    'conv_closed_notice' => 'هذه المحادثة مغلقة. لا يمكنك إرسال رسائل جديدة.',
    'conv_load_older' => 'تحميل الرسائل القديمة',
    'conv_edit_tooltip' => 'تعديل',
    'conv_attachment' => 'مرفق',
    'conv_no_previous_messages' => 'لا توجد رسائل سابقة. ابدأ المحادثة الآن!',
    'conv_attach_file' => 'إرفاق ملف',
    'conv_quick_replies' => 'الردود السريعة',
    'conv_no_quick_replies' => 'لا توجد ردود سريعة',
    'conv_type_message' => 'اكتب رسالة...',
    'conv_closed_notice_full' => 'هذه المحادثة مغلقة. لا يمكنك إرسال رسائل جديدة إلا إذا قمت بإعادة فتحها.',
    'conv_assign_title' => 'تعيين المحادثة',
    'conv_unassigned' => 'بدون تعيين',
    'conv_save' => 'حفظ',
    'conv_internal_notes' => 'ملاحظات داخلية',
    'conv_activity_log' => 'سجل الأنشطة',
    'conv_confirm_delete_note' => 'هل أنت متأكد من حذف هذه الملاحظة؟',
    'conv_no_internal_notes' => 'لا توجد ملاحظات داخلية',
    'conv_note_placeholder' => 'اكتب ملاحظة مرئية لفريق العمل فقط...',
    'conv_add_note' => 'إضافة ملاحظة',
    'conv_no_activity_log' => 'لا يوجد سجل للأنشطة',
    'conv_js_done_title' => 'تم',
    'conv_js_ok' => 'حسناً',
    'conv_js_alert_title' => 'تنبيه',
    'conv_js_error_title' => 'خطأ',
    'conv_file_too_large' => 'حجم الملف كبير جداً (أقصى حجم 10 ميغابايت)',
    'conv_err_generic' => 'حدث خطأ أثناء الاتصال بالخادم.',
    'conv_err_413' => 'حجم الملف كبير جداً وتجاوز الحد المسموح به.',
    'conv_err_419' => 'انتهت الجلسة، يرجى تحديث الصفحة.',
    'conv_err_422' => 'البيانات المدخلة غير صالحة.',
    'conv_send_failed_title' => 'فشل الإرسال',
    'conv_unknown_error' => 'خطأ غير معروف',
    'conv_connection_lost' => 'انقطع الاتصال بالإنترنت أو الخادم غير متاح.',
    'conv_new_attachment_received' => 'تم استلام مرفق جديد',
    'conv_new_message_from' => 'رسالة جديدة من',
    'conv_close_conversation_title' => 'إغلاق المحادثة',
    'conv_yes_close' => 'نعم، إغلاق',
    'conv_edit_message_title' => 'تعديل الرسالة',
    'conv_write_message_here' => 'اكتب رسالتك هنا',
    'conv_save_edits' => 'حفظ التعديلات',
    'conv_message_empty' => 'الرسالة لا يمكن أن تكون فارغة',
    'conv_update_failed_prefix' => 'فشل التحديث',
    'conv_edited_success' => 'تم التعديل!',
    'conv_delete_message_title' => 'حذف الرسالة',
    'conv_confirm_delete_message' => 'هل أنت متأكد من حذف هذه الرسالة؟ لن يمكنك التراجع عن ذلك.',
    'conv_yes_delete' => 'نعم، احذفها',
    'conv_delete_failed_prefix' => 'فشل الحذف',
    'conv_message_deleted_marker' => '🚫 تم حذف هذه الرسالة',
    'conv_deleted_success' => 'تم الحذف!',

    // Failed jobs
    'fj_total_records' => 'إجمالي السجلات',
    'fj_all_queues' => 'جميع الطوابير',
    'fj_clear' => 'إلغاء',
    'fj_export_excel' => 'تصدير Excel',
    'fj_restart_queue_worker_title' => 'إعادة تشغيل عامل الطابور (الخدمة التي تعالج المهام)',
    'fj_restart_services' => 'إعادة تشغيل الخدمات',
    'fj_confirm_retry_all' => 'هل أنت متأكد من إعادة محاولة كافة المهام الفاشلة؟',
    'fj_retry_all' => 'إعادة محاولة الكل',
    'fj_confirm_flush' => 'تحذير: سيتم مسح كافة المهام الفاشلة نهائياً من السجل. هل أنت متأكد؟',
    'fj_flush_all' => 'مسح الكل',
    'fj_col_id' => 'المعرف',
    'fj_col_queue_type' => 'الطابور / النوع',
    'fj_col_failed_at' => 'وقت الفشل',
    'fj_col_error' => 'الخطأ التقني',
    'fj_unknown' => 'غير معروف',
    'fj_queue_label' => 'طابور',
    'fj_retry' => 'إعادة المحاولة',
    'fj_confirm_forget' => 'هل أنت متأكد من مسح هذه المهمة؟',
    'fj_no_failed_jobs' => 'لا توجد مهام فاشلة في السجل',
    'fj_back_to_system_health' => 'العودة إلى لوحة صحة النظام',

    // Users
    'users_list_title' => 'قائمة المستخدمين',
    'users_export_title' => 'تصدير النتائج إلى ملف Excel (CSV)',
    'users_add_user' => 'إضافة مستخدم',
    'users_col_name' => 'الاسم',
    'users_col_email' => 'البريد الإلكتروني',
    'users_col_role' => 'الدور',
    'users_auto_distribution_title' => 'هل يستلم هذا المستخدم محادثات جديدة عبر التوزيع التلقائي؟ راجع إعدادات توزيع المحادثات',
    'users_col_auto_distribution' => 'التوزيع التلقائي',
    'users_col_last_login' => 'آخر تسجيل دخول',
    'users_col_created_at' => 'تاريخ الإنشاء',
    'users_role_admin' => 'مدير نظام',
    'users_role_supervisor' => 'مشرف',
    'users_role_agent' => 'موظف خدمة عملاء',
    'users_available_title' => 'متاح لاستلام محادثات جديدة تلقائياً',
    'users_available' => 'متاح',
    'users_unavailable' => 'غير متاح',
    'users_confirm_delete' => 'هل أنت متأكد من حذف هذا المستخدم؟',
    'users_phone_hint' => 'إن أُدخل، يصل هذا المستخدم إشعار واتساب فعلي (بالإضافة لجرس الإشعارات) عند تعيين محادثة له.',
    'users_col_account_status' => 'حالة الحساب',
    'users_account_status_title' => 'تفعيل أو تعطيل حساب المستخدم — المستخدم المُعطَّل لا يستطيع تسجيل الدخول',
    'users_status_active' => 'مفعّل',
    'users_status_inactive' => 'موقوف',
    'users_confirm_deactivate' => 'هل أنت متأكد من تعطيل هذا الحساب؟ لن يتمكن المستخدم من تسجيل الدخول حتى تُعيد تفعيله.',
    'users_confirm_activate' => 'هل أنت متأكد من تفعيل هذا الحساب؟ سيتمكن المستخدم من تسجيل الدخول مجدداً.',
    'users_deactivate_title' => 'انقر لتعطيل هذا الحساب',
    'users_activate_title' => 'انقر لتفعيل هذا الحساب',
    'users_account_deactivated_hint' => 'الحساب موقوف',
    'users_own_account_hint' => 'لا يمكنك تعطيل حسابك الشخصي',
    'edit_rule' => 'تعديل قاعدة',
    'save_changes' => 'حفظ التعديلات',
    'no_rules_yet' => 'لا توجد قواعد بعد — أي رسالة PDF واردة ستُرسل للطابعة الافتراضية فقط (إن وُجدت)',

    // صفحة الإعدادات
    'settings_title' => 'إعدادات النظام (System Settings)',
    'save_settings' => 'حفظ الإعدادات',
    'enabled' => 'مفعّل',
    'disabled' => 'معطّل',
    'comma_separated' => 'مفصولة بفواصل',

    'settings_system_info' => 'معلومات النظام والجهاز (System Info)',
    'settings_local_system_name' => 'اسم النظام المحلي (LOCAL_SYSTEM_NAME)',
    'settings_local_system_name_placeholder' => 'فرع الرياض',
    'settings_local_system_name_help' => 'الاسم المميز لهذا النظام المحلي (يظهر في التنبيهات والتقارير).',
    'settings_device_name' => 'اسم الجهاز (DEVICE_NAME)',
    'settings_location' => 'الموقع (LOCATION)',
    'settings_plan_type' => 'نوع الباقة (PLAN_TYPE)',

    'settings_central_api' => 'الواجهة المركزية (Central API)',
    'settings_company_id' => 'معرف الشركة (CENTRAL_API_COMPANY_ID)',
    'settings_api_token' => 'رمز المصادقة الصادر (CENTRAL_API_TOKEN)',
    'settings_api_token_help' => 'يستخدمه هذا النظام كـ Bearer عند استدعاء API النظام المركزي (إرسال الرسائل، مزامنة الحالة). يطابق "التوكن السري" الظاهر في صفحة الشركة بالنظام المركزي.',
    'settings_webhook_token' => 'رمز التحقق من الويب هوك الوارد (CENTRAL_WEBHOOK_TOKEN)',
    'settings_webhook_token_placeholder' => 'اتركه فارغاً لاستخدام CENTRAL_API_TOKEN مؤقتاً (غير مُوصى به)',
    'settings_webhook_token_help' => '<strong>أفضل ممارسة:</strong> توكن مستقل تماماً عن الأعلى — يتحقق به هذا النظام أن أي طلب ويب هوك واصل فعلاً من النظام المركزي، وليس نفس التوكن المستخدم للاتصال الصادر. يجب أن يطابق قيمة "التوكن" الخاصة بنقطة الويب هوك المرتبطة بهذا النظام تحديداً في صفحة "الأنظمة الخارجية المرتبطة" بالنظام المركزي (وليس التوكن السري العام للشركة). اتركه فارغاً فقط للتوافق المؤقت مع الإعداد القديم.',
    'settings_retry_attempts' => 'محاولات إعادة الاتصال (CENTRAL_API_RETRY_ATTEMPTS)',
    'settings_retry_delay' => 'تأخير إعادة الاتصال بالثواني (CENTRAL_API_RETRY_DELAY)',

    'settings_local_retry' => 'إعادة المحاولة (Local Retry)',
    'settings_max_retry_attempts' => 'الحد الأقصى لمحاولات إعادة الإرسال (MAX_RETRY_ATTEMPTS)',
    'settings_retry_delay_minutes' => 'تأخير إعادة الإرسال بالدقائق (RETRY_DELAY_MINUTES)',

    'settings_alerts_monitoring' => 'التنبيهات والمراقبة (Alerts & Monitoring)',
    'settings_admin_phone' => 'رقم جوال المسؤول (PRINTER_ALERT_PHONE)',
    'settings_admin_phone_help' => 'رقم (أو أرقام مفصولة بفواصل) جوال المسؤول الذي تصله كل التنبيهات: تعطل الطابعات، طلبات الموافقة، وتنبيهات صحة النظام. اتركه فارغاً لتعطيل التنبيهات.',
    'settings_default_message_text' => 'نص الرسالة الافتراضي (MONITORING_MESSAGE_TEXT)',
    'settings_require_approval' => 'طلب موافقة قبل الإرسال (MONITOR_FOLDER_REQUIRE_APPROVAL)',
    'settings_require_approval_off' => 'معطّل (إرسال تلقائي فوري — الوضع المعتاد)',
    'settings_require_approval_on' => 'مفعّل (حجز كل ملف بانتظار موافقة يدوية)',
    'settings_require_approval_help' => 'عند التفعيل، كل ملف يصل عبر مجلد المراقبة يُحجز بانتظار موافقة صريحة قبل إرساله عبر واتساب.',

    'settings_smart_printing' => 'الطباعة الذكية (Smart Printing)',
    'settings_printing_enabled' => 'تفعيل الطباعة الذكية (PRINTING_ENABLED)',
    'settings_page_size' => 'مقاس الورق (PRINT_IMAGE_PAGE_SIZE)',
    'settings_page_size_help' => 'يجب أن يطابق الورق المُحمّل فعلياً في الطابعة.',
    'settings_dpi' => 'دقة الطباعة DPI (PRINT_IMAGE_DPI)',
    'settings_dpi_help' => '200 قيمة متوازنة بين الوضوح وحجم الملف.',
    'settings_reminder_after' => 'تذكير بطلب الموافقة بعد (دقيقة)',
    'settings_reminder_after_help' => 'بعد كم دقيقة من بقاء طلب موافقة بلا رد يُرسَل تذكير تلقائي للمسؤول.',
    'settings_reminder_repeat' => 'تكرار التذكير كل (دقيقة)',
    'settings_reminder_repeat_help' => 'اضبطه على 0 لتعطيل التذكير التلقائي كلياً.',
    'settings_printable_extensions' => 'الامتدادات القابلة للطباعة (PRINTABLE_EXTENSIONS)',

    'settings_printing_notifications' => 'إشعارات حالة الطباعة الذكية',
    'settings_ack_on_receipt' => 'رد فوري عند استلام الطلب (PRINTING_REPLY_ACK_ON_RECEIPT)',
    'settings_ack_on_receipt_on' => 'مفعّل ("📥 تم استلام طلبك وجاري تنفيذه" فور تسجيل الطلب)',
    'settings_ack_on_receipt_help' => 'رسالة منفصلة عن رد النتيجة النهائية — لطمأنة العميل أن ملفه وصل بشكل صحيح.',
    'settings_reply_to_sender' => 'الرد على من طلب الطباعة (PRINTING_REPLY_STATUS_TO_SENDER)',
    'settings_reply_to_sender_on' => 'مفعّل (يصل العميل رسالة تلقائية بنجاح/فشل طباعة ملفه)',
    'settings_reply_to_sender_help' => 'لا يُرسَل عند كل محاولة فاشلة، فقط عند النجاح أو الفشل النهائي بعد استنفاد كل المحاولات.',
    'settings_notify_owner' => 'تنبيه فني لصاحب المنشأة عند الفشل (PRINTING_NOTIFY_OWNER_ON_JOB_FAILURE)',
    'settings_notify_owner_on' => 'مفعّل (يصل الخطأ التقني الكامل لرقم المسؤول)',

    'settings_file_settings' => 'إعدادات الملفات (File Settings)',
    'settings_storage_path' => 'مسار التخزين (FILE_STORAGE_PATH)',
    'settings_max_size' => 'أقصى حجم بالميغابايت (FILE_MAX_SIZE_MB)',
    'settings_auto_delete_days' => 'الحذف التلقائي بعد (أيام) (FILE_AUTO_DELETE_DAYS)',
    'settings_backup_retention' => 'الاحتفاظ بالنسخ الاحتياطية (أيام) (BACKUP_RETENTION_DAYS)',
    'settings_backup_retention_help' => 'عدد الأيام للاحتفاظ بالنسخ الاحتياطية التلقائية قبل حذفها.',
    'settings_allowed_types' => 'الأنواع المسموحة (FILE_ALLOWED_TYPES)',

    'settings_extraction_title' => 'استخراج رقم الجوال من محتوى الملفات (PDF/DOCX)',
    'settings_extraction_intro' => 'تُستخدم هذه الإعدادات عندما لا يحتوي اسم الملف على رقم جوال، فيبحث النظام داخل محتوى الملف نفسه.',
    'settings_country_code' => 'كود الدولة الافتراضي (DEFAULT_COUNTRY_CODE)',
    'settings_smart_extraction' => 'للاستخراج الذكي',
    'settings_country_code_placeholder' => 'مثال: 966 أو 20',
    'settings_country_code_help' => 'يُضاف تلقائياً إذا تم استخراج رقم بدون مفتاح أو يبدأ بصفر (يقوم النظام بحذف الصفر وإضافة هذا الكود).',
    'settings_extraction_method' => 'آلية استخراج الرقم (PRINT_EXTRACTION_METHOD)',
    'settings_extraction_ocr' => 'قراءة الرقم آلياً من محتوى الملف (الافتراضي الذكي)',
    'settings_extraction_popup' => 'إدخال يدوي من الموقع عند فشل الاستخراج التلقائي',
    'settings_extraction_filename' => 'استخراج من اسم الملف فقط (لا يبحث داخل الملف)',
    'settings_extraction_method_help' => 'في كل الأوضاع الثلاثة يُحاوَل استخراج الرقم أولاً من اسم الملف، ثم من محتواه (إلا في وضع "اسم الملف فقط"). الفرق فقط عند فشل كل محاولات الاستخراج: "الافتراضي الذكي"/"اسم الملف فقط" ينقلان الملف مباشرة لمجلد "فشلت"، بينما "إدخال يدوي من الموقع" يحجزه في تبويب "بانتظار المراجعة" بصفحة متابعة الإرسال (<a href="' . url('/print-monitor') . '" class="text-indigo-600 hover:underline">/print-monitor</a>) لتُدخل الرقم يدوياً من هناك ثم يُرسَل. لا يوجد نافذة نظام منبثقة فعلية — هذا لا يمكن أن يعمل مطلقاً في مهمة مجدولة بلا جلسة تفاعلية (Session 0)، لذا استُبدل بهذا المسار العملي عبر الويب.',
    'settings_phone_labels' => 'كلمات البحث عن رقم الجوال (PHONE_EXTRACTION_LABELS)',
    'settings_phone_labels_help' => 'إذا كانت المطابقة قريبة من إحدى هذه الكلمات يُعتبر الرقم بعدها رقم جوال العميل.',
    'settings_exclude_context' => 'كلمات الاستبعاد (PHONE_EXTRACTION_EXCLUDE_CONTEXT)',
    'settings_exclude_context_help' => 'إذا ظهرت إحدى هذه الكلمات قبل رقم الجوال مباشرة (مثل "هاتف المحل") يتم تجاهل هذا الرقم لأنه رقم الجهة المُصدرة وليس العميل.',
    'settings_file_number_labels' => 'كلمات البحث عن رقم الملف (FILE_NUMBER_LABELS)',
    'settings_file_number_labels_help' => 'عند العثور على رقم بجانب إحدى هذه الكلمات يبحث النظام عن جهة اتصال بنفس رقم الملف ويرسل لرقم جوالها.',
    'settings_match_mode' => 'نمط المطابقة (PHONE_MATCH_MODE)',
    'settings_match_partial' => 'جزئي (الكلمة كجزء من نص أطول)',
    'settings_match_exact' => 'كامل (الكلمة ككلمة مستقلة فقط)',
    'settings_match_mode_help' => '"جزئي" يطابق "جوال" حتى داخل "جوالكم"، أما "كامل" فيتطلب الكلمة منفصلة تماماً.',
    'settings_unlabeled_fallback' => 'السماح بالاستخراج بلا تسمية (ENABLE_UNLABELED_PHONE_FALLBACK)',
    'settings_unlabeled_fallback_on' => 'مفعّل (يبحث عن أي رقم يشبه جوال سعودي بلا تسمية كحل أخير)',
    'settings_unlabeled_fallback_off' => 'معطّل (إن لم توجد تسمية صريحة يُنقل الملف لمجلد "فشلت")',
    'settings_review_sources' => 'مصادر تتطلب مراجعة يدوية قبل الإرسال (PHONE_REVIEW_REQUIRED_SOURCES)',
    'settings_review_sources_help' => 'بدلاً من الإرسال التلقائي مباشرة، أي ملف يُستخرج رقمه من أحد هذه المصادر (منخفضة الثقة) يُحجز في تبويب "بانتظار المراجعة" بصفحة متابعة الإرسال حتى تُوافق عليه يدوياً.',
    'settings_review_sources_values' => 'القيم الممكنة',
    'settings_review_sources_empty' => 'اتركه فارغاً للإرسال التلقائي دائماً (بدون مراجعة).',

    'settings_duplicate_learning_title' => 'كشف التكرار والتعلّم من التصحيح اليدوي',
    'settings_duplicate_detection' => 'كشف التكرار (DUPLICATE_DETECTION_ENABLED)',
    'settings_duplicate_detection_help' => 'يحجز للمراجعة اليدوية أي ملف بنفس محتوى ملف سبق إرساله لنفس الرقم مؤخراً، بدل إرساله تلقائياً مرة ثانية.',
    'settings_duplicate_window' => 'نافذة كشف التكرار بالدقائق (DUPLICATE_DETECTION_WINDOW_MINUTES)',
    'settings_learned_trust_threshold' => 'حد الثقة المكتسبة (LEARNED_TRUST_THRESHOLD)',
    'settings_learned_trust_threshold_help' => 'عدد مرات الموافقة اليدوية على نفس الرقم من نفس المصدر منخفض الثقة قبل تخطي المراجعة تلقائياً في المرات القادمة. رفض واحد يُسقط الثقة فوراً. 0 يعطّل الميزة.',

    'settings_distribution_title' => 'توزيع المحادثات الجديدة (Conversation Distribution)',
    'settings_distribution_mode' => 'وضع التعيين (CONVERSATION_DISTRIBUTION_MODE)',
    'settings_distribution_manual' => 'يدوي (بلا تعيين تلقائي — التعيين من صفحة المحادثات فقط)',
    'settings_distribution_specific' => 'تلقائي لمستخدمين محددين',
    'settings_distribution_all' => 'تلقائي لكل الموظفين (role = agent) المتاحين للتعيين',
    'settings_distribution_help' => 'عند التعيين التلقائي (أي وضع غير "يدوي")، تذهب كل محادثة جديدة تلقائياً لمن لديه حالياً <strong>أقل عدد محادثات مفتوحة</strong> من المجموعة المؤهّلة — توازن حمل حقيقي، وليس تناوباً دورياً أعمى لا يراعي تراكم محادثات موظف معيّن. قواعد الأتمتة (تعيين حسب رقم/كلمة مفتاحية من صفحة "الأتمتة") تبقى تعمل بمعزل عن هذا الإعداد وتُطبَّق بعده، فتستطيع أن تُلغي التعيين التلقائي لحالات محددة.',
    'settings_distribution_users' => 'المستخدمون المشمولون بالتوزيع (CONVERSATION_DISTRIBUTION_USER_IDS)',
    'settings_currently_unavailable' => 'غير متاح حالياً',
    'settings_no_users_yet' => 'لا يوجد مستخدمون بعد.',
    'settings_distribution_users_help' => 'مستخدم "غير متاح حالياً" (راجع صفحة إدارة المستخدمين) يُستبعد تلقائياً من التوزيع حتى لو بقي محدداً هنا — مفيد لاستثنائه مؤقتاً (إجازة) بلا تعديل هذه القائمة.',

    'settings_backlog_threshold' => 'حد التنبيه لتراكم المهام (HEALTH_ALERT_QUEUE_BACKLOG_THRESHOLD)',
    'settings_backlog_threshold_help' => 'فوق كم مهمة متراكمة في طابور المعالجة يُرسَل تنبيه واتساب فوري للمسؤول.',
    'settings_alert_cooldown' => 'فترة تهدئة التنبيهات (دقيقة) (HEALTH_ALERT_COOLDOWN_MINUTES)',
    'settings_alert_cooldown_help' => 'بعد إرسال تنبيه صحة النظام، كم دقيقة ننتظر قبل السماح بتكراره. اضبطه على 0 لتعطيل التنبيهات كلياً.',

    // إرسال رسالة جديدة
    'compose_title' => 'إرسال رسالة جديدة',
    'compose_phone_intl' => 'رقم الجوال (دولي)',
    'compose_phone_placeholder' => 'ابحث بالاسم أو الرقم... أو أدخل رقم جديد',
    'compose_searching' => 'جاري البحث...',
    'compose_no_results' => 'لا توجد نتائج مطابقة',
    'remove' => 'إزالة',
    'compose_phone_help' => 'أدخل الرمز الدولي متبوعاً برقم الجوال (بدون + أو 00) أو ابحث باسم العميل',
    'compose_message_text' => 'نص الرسالة',
    'compose_message_placeholder' => 'اكتب نص الرسالة هنا...',
    'compose_attachments' => 'المرفقات (عدة ملفات)',
    'compose_choose_files' => 'اختر الملفات',
    'compose_or_drag' => 'أو اسحب وأفلت',
    'compose_file_types_hint' => 'PNG, JPG, PDF, DOC, XLS حتى 10 ميجابايت للملف',
    'compose_selected_files' => 'الملفات المحددة:',
    'compose_delete_all' => 'حذف الكل',
    'compose_tips_title' => 'نصائح هامة',
    'compose_tip_1' => 'تأكد من صحة الرقم الدولي المدخل',
    'compose_tip_2' => 'استخدم الأرقام بالصيغة الدولية (مثال: 966501234567)',
    'compose_tip_3' => 'يمكنك تحديد عدة ملفات معاً، وسيتم إرسالها بفاصل زمني عشوائي بين 1 إلى 10 ثواني',
    'compose_tip_4' => 'الحد الأقصى لحجم الملف 10 ميجابايت',
    'compose_send' => 'إرسال الرسالة',

    // تقارير الأداء
    'reports_title' => 'تقارير الأداء لخدمة العملاء',
    'reports_total_conversations' => 'إجمالي المحادثات',
    'reports_open_conversations' => 'محادثات مفتوحة',
    'reports_closed_conversations' => 'محادثات مغلقة',
    'reports_this_month' => 'محادثات هذا الشهر',
    'reports_agent_performance' => 'أداء الوكلاء (المحادثات المغلقة)',
    'reports_agent_name' => 'اسم الوكيل',
    'reports_closed_count' => 'عدد المحادثات المنجزة',
    'reports_percentage' => 'النسبة',
    'reports_no_data' => 'لا توجد بيانات متاحة',
    'reports_message_distribution' => 'توزيع الرسائل',
    'reports_incoming' => 'رسائل واردة (من العملاء)',
    'reports_outgoing' => 'رسائل صادرة (من النظام)',
    'reports_total_messages' => 'إجمالي الرسائل في النظام',

    // أدوات PDF
    'pdf_merge_title' => 'دمج ملفات PDF',
    'pdf_merge_help' => 'اختر ملفين أو أكثر ليُدمَجوا في ملف واحد بنفس الترتيب. يمكنك إضافة ملفات من أماكن مختلفة بالضغط على "إضافة ملفات" عدة مرات.',
    'pdf_add_files' => 'إضافة ملفات',
    'pdf_selected_files' => 'الملفات المحددة (سيتم دمجها بنفس الترتيب):',
    'pdf_merge_button' => 'دمج وتنزيل',
    'pdf_merge_min_files' => 'يجب اختيار ملفين على الأقل للدمج',
    'pdf_split_title' => 'استخراج صفحات من PDF',
    'pdf_split_help' => 'اختر ملفاً ونطاق الصفحات المطلوب استخراجه كملف منفصل.',
    'pdf_from_page' => 'من صفحة',
    'pdf_to_page' => 'إلى صفحة',
    'pdf_split_button' => 'استخراج وتنزيل',
    'pdf_compress_title' => 'ضغط صورة',
    'pdf_compress_help' => 'لتصغير حجم صورة كبيرة قبل إرسالها عبر واتساب (JPG/PNG).',
    'pdf_quality' => 'الجودة (10-95)',
    'pdf_compress_button' => 'ضغط وتنزيل',

    // محرك الأتمتة العام
    'automation_title' => 'محرك الأتمتة العام',
    'automation_intro' => 'عند وصول رسالة جديدة، يُفحص شرط كل قاعدة نشطة بالترتيب (الأولوية الأصغر أولاً)، وأول قاعدة مطابقة فقط تُنفَّذ إجراؤها.',
    'automation_add_rule' => 'إضافة قاعدة أتمتة',
    'automation_rule_name_placeholder' => 'تعيين شكاوى VIP',
    'automation_condition_type' => 'نوع الشرط',
    'automation_match_keyword_multi' => 'كلمة مفتاحية (افصل بفاصلة لأكثر من كلمة)',
    'automation_condition_value' => 'قيمة الشرط',
    'automation_condition_value_placeholder' => 'شكوى,مشكلة,استفسار',
    'automation_action_type' => 'نوع الإجراء',
    'automation_action_assign' => 'تعيين المحادثة لموظف',
    'automation_action_note' => 'إضافة ملاحظة داخلية',
    'automation_action_reply' => 'رد تلقائي فوري',
    'automation_action_value' => 'قيمة الإجراء',
    'automation_choose_agent' => '— اختر موظفاً (لإجراء «تعيين لموظف» فقط) —',
    'automation_action_value_placeholder' => 'نص الملاحظة أو الرد التلقائي، أو معرّف الموظف أعلاه',
    'automation_action_hint' => 'لإجراء "تعيين لموظف": اختر الموظف من القائمة (يملأ الحقل تلقائياً بمعرّفه). لباقي الإجراءات: اكتب النص مباشرة.',
    'automation_assigned_to_agent' => 'تعيين للموظف #',
    'automation_note_label' => 'ملاحظة:',
    'automation_reply_label' => 'رد تلقائي:',
    'automation_no_rules' => 'لا توجد قواعد أتمتة بعد',

    // Docs page (auto-generated section blocks)
    'docs_page_title' => 'دليل استخدام نظام الواتساب المحلي',
    'docs_s1' => <<<'EOT'
...
EOT,
    'audit_event_login' => 'تسجيل دخول',
    'audit_event_logout' => 'تسجيل خروج',
    'audit_event_failed_login' => 'محاولة دخول فاشلة',
    'printer_status_check_warning' => 'هذه الطابعة تُبلّغ فعلياً عن أعطالها (نفاد ورق/حبر) عبر Windows — لا تُفعّلها إلا بعد التأكد يدوياً، وإلا فقد يصل العميل تأكيد طباعة كاذب.',
    'printer_windows_name_help' => 'استخدم بالضبط الاسم كما يظهر في أمر <code>Get-Printer</code> على Windows.',
...
<a href=":url" class="text-indigo-600 hover:underline">سجل عمليات الطباعة</a>
...
<a href=":url" class="text-indigo-600 hover:underline">قاعدة توجيه</a>
...
<code>:path\print\&lt;اسم الطابعة&gt;\</code>
...
EOT,
    'printer_direct_folder_tooltip' => 'مجلد الطباعة المحلية المباشرة لهذه الطابعة',
