                        ...
                        @forelse($printers as $printer)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap space-x-2 space-x-reverse">
                                    ...
                                    <form action="{{ route('printers.destroy', $printer) }}" method="POST" class="inline m-0 p-0" onsubmit="return confirm('هل أنت متأكد من حذف هذه الطابعة؟ سيتم حذف كل قواعد الطباعة المرتبطة بها.');">
                                        @csrf @method('DELETE')
