    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-lg text-[#f53003] dark:text-[#FF4433]">مرحباً بك في نظام الواتساب
                    المحلي</h1>
                <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">يمكنك الآن ارسال رسائل و ملفات من النظام المحلي  والتواصل مع عملائك بسهولة وسرعة من خلال واجهة النظام المتطورة.</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>
                                ابدأ بقراءة 
                                <a href="{{ route('docs') }}" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ml-1">
